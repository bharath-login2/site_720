...
class WorkDetails extends StatelessWidget {
 ...
 Future<void> workDialog(BuildContext context) async {
  String isWorking = 'Yes'; // Default value for radio button
  String? selectedStatus; // For the status dropdown
  final List<String> statuses = ["Company Issue", "Client Issue", "Payment Pending", "General Issue"];
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,color:AppColors.errorColor),
                ),
                Row(
                  children: [
                    Radio<String>(
                ...
                GestureDetector(
                  onTap: () async {
                    snackBar(context, 'Work Details Added Successfully!', Colors.black);
                    Navigator.pop(context);
                  },
                  ...
                  Center(
                    child: TextButton(
                      onPressed: () {
                        // Clear or reset fields if needed
                        Navigator.pop(context);
                      },
