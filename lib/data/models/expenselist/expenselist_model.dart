...
GetExpenseList getExpenseListFromJson(String str) => GetExpenseList.fromJson(json.decode(str));
...
class GetExpenseList {
    ...
    factory GetExpenseList.fromJson(Map<String, dynamic> json) => GetExpenseList(
        data: List<ExpenseList>.from(json["data"].map((x) => ExpenseList.fromJson(x))),
